...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/SpaceInvaders/SpaceInvaders.runs/SpaceInvaders_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpaceInvaders_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpaceInvaders_rst_ps7_0_100M_0.tcl
