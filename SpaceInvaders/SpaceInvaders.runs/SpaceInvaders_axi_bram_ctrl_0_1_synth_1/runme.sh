...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/SpaceInvaders/SpaceInvaders.runs/SpaceInvaders_axi_bram_ctrl_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpaceInvaders_axi_bram_ctrl_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpaceInvaders_axi_bram_ctrl_0_1.tcl
