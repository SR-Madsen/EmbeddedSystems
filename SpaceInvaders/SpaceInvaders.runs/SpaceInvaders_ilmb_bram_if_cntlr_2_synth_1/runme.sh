...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/SpaceInvaders/SpaceInvaders.runs/SpaceInvaders_ilmb_bram_if_cntlr_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpaceInvaders_ilmb_bram_if_cntlr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpaceInvaders_ilmb_bram_if_cntlr_2.tcl
