...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/SpaceInvaders/SpaceInvaders.runs/SpaceInvaders_lmb_bram_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpaceInvaders_lmb_bram_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpaceInvaders_lmb_bram_2.tcl
