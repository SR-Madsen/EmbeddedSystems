...
// Game over
void gameOver() {
	writePixelValueDirect(3, 6, 255, 0, 0);
	writePixelValueDirect(6, 6, 255, 0, 0);
	writePixelValueDirect(2, 3, 255, 0, 0);
	writePixelValueDirect(3, 4, 255, 0, 0);
	writePixelValueDirect(4, 4, 255, 0, 0);
	writePixelValueDirect(5, 4, 255, 0, 0);
