...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Lab4/Lab4.runs/Lab3_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_axi_bram_ctrl_0_0.tcl
