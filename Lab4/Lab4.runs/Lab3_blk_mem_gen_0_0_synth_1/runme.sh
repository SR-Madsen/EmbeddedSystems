...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Lab4/Lab4.runs/Lab3_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_blk_mem_gen_0_0.tcl
