...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Lab4/Lab4.runs/Lab4_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab4_blk_mem_gen_0_0.tcl
