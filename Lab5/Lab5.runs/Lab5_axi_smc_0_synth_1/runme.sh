...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Lab5/Lab5.runs/Lab5_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_axi_smc_0.tcl
