...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Workshop1/Workshop1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log workshop1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source workshop1.tcl
