...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Workshop1/Workshop1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log workshop1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source workshop1.tcl -notrace
