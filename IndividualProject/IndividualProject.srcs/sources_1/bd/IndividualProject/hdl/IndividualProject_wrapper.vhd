...
entity IndividualProject_wrapper is
  port (
...
end IndividualProject_wrapper;

architecture STRUCTURE of IndividualProject_wrapper is
  component IndividualProject is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
IndividualProject_i: component IndividualProject
     port map (
      ...
      GPIO_gyro_tri_i(0) => GPIO_gyro_tri_i(0),
