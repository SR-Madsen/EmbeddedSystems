...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/SimulationProject/SimulationProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_driver.tcl -notrace
