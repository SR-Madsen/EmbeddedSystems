...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/SimulationProject/SimulationProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_driver.tcl
