...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/XADC_intr/XADC_intr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_intr_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XADC_intr_wrapper.tcl -notrace
