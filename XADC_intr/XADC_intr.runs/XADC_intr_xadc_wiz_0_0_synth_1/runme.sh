...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/XADC_intr/XADC_intr.runs/XADC_intr_xadc_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XADC_intr_xadc_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XADC_intr_xadc_wiz_0_0.tcl
