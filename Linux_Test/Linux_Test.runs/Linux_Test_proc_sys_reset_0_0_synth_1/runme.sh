...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Linux_Test/Linux_Test.runs/Linux_Test_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Linux_Test_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Linux_Test_proc_sys_reset_0_0.tcl
