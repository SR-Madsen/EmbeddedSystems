...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Linux_Test/Linux_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Linux_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Linux_Test_wrapper.tcl -notrace
