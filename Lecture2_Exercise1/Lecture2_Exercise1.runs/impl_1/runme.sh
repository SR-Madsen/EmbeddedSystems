...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Lecture2_Exercise1/Lecture2_Exercise1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exercise.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exercise.tcl -notrace
