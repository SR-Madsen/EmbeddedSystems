...
HD_PWD='/home/sebastian/Desktop/Git/EmbeddedSystems/Lecture2_Exercise1/Lecture2_Exercise1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exercise.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exercise.tcl
